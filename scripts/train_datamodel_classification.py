...
from tevatron.retriever.modeling import T5FusionRegression, T5Regression, BERTRegression, BERTBinaryClassification
...
model = BERTBinaryClassification(model_to_train, n_fusion=11) # 1pos 9neg 1query
