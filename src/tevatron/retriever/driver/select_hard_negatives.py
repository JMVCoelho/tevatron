...
import os
import sys
from tevatron.retriever.data_selection import RandomHardNegatives, InDiHardNegatives, LESSHardNegatives, LESSHardNegativesOpacus, LESSHardNegativesQueryLevelValid, LESSHardNegativesQueryLevelOpacus
...
def main():
    ...
    elif data_args.method == "valid_query_level":
        sampler = LESSHardNegativesQueryLevelValid(qrels_path=data_args.train_qrels, 
                                    run_path=data_args.train_run_path,
