...
class ModelArguments:
    ...
    checkpoint: Optional[str] = field(
        default=None, metadata={"help": "path to model with checkpoint"}
    )

    matrioshka_linear_layer: Optional[int] = field(
        default=None,
        metadata={"help": "matrioshka linear layer out dimension"},
    )
...
class DataArguments:
    ...
    eval_dataset_path: str = field(
        default=None,
        metadata={"help": "Path to local data files or directory for evaluation"},
    )
