...
#trained_model_name=pythia-160m-marco-docs-bow-pretrain-bs64-repetition
#base_model=/data/user_data/jmcoelho/models/pre-trained/pythia-160m-1024-marco-docs-bow-hf

trained_model_name=pythia-160m-marco-docs-bow-pretrain-bs64-repetition-self-hn1
base_model=/data/user_data/jmcoelho/models/fine-tuned/pythia-160m-marco-docs-bow-pretrain-bs64-repetition
...
deepspeed --include localhost:0,1,2,3 --master_port 26500 --module tevatron.retriever.driver.train \
  ...
  --local \
  --dataset_path "/data/user_data/jmcoelho/datasets/marco/documents/processed_data/pythia-160m-marco-docs-bow-pretrain-bs64-repetition/train.jsonl" \
  --save_steps 1000 \
  --bf16 \
  --pooling eos \
