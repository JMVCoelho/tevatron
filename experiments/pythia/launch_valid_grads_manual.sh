...
model_name=pythia-160m-marco-docs-bow-ct-pretrain-bs64-10pc-sample-less-negs-self-hn1
model_to_valid=/data/user_data/jmcoelho/models/fine-tuned/$model_name
save_grad=/data/user_data/jmcoelho/embeddings/marco_docs/$model_name/valid_grads_larger

mkdir -p $save_grad

python -m tevatron.retriever.driver.valid_grads_manual \
  --output_dir temp \
