...
trained_model_name=pythia-160m-marco-docs-bow-matrioshka-pretrain-bow-matrioshka-ft
base_model=/data/user_data/jmcoelho/models/pre-trained/pythia-160m-1024-marco-docs-bow-matrioshka-hf/
