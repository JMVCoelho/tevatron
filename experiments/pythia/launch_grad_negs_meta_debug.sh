...
python -m tevatron.retriever.driver.select_hard_negatives \
    ...
    --train_run_path /data/user_data/jmcoelho/embeddings/marco_docs/pythia-160m-marco-docs-bow-pretrain/run.train.txt \
    ...
    --negatives_out_file /data/user_data/jmcoelho/embeddings/marco_docs/pythia-160m-marco-docs-bow-pretrain/meta_train_runs_debug/hardnegs_debug.txt \
    --output_dir temp \
