...
deepspeed --include localhost:0 --master_port $port --module tevatron.retriever.driver.train \
  ...
  --dataset_path /data/user_data/jmcoelho/datasets/marco/documents/processed_data/pythia-160m-marco-docs-bow-ct-pretrain-bs128-20pc-sample-less-negs-triplet-topk/random_20_pc_sample_denoised/val.jsonl \
