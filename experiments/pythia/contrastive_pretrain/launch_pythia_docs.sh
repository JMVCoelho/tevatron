...
trained_model_name=pythia-160m-marco-docs-contrastive-pretrain
base_model=/data/user_data/jmcoelho/models/pre-trained/pythia-160m-1024-marco-docs-contrastive-hf/
