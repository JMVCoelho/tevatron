...
python -m tevatron.retriever.driver.select_hard_negatives \
    ...
    --number_of_negatives $n_negatives \
    --negatives_out_file /data/user_data/jmcoelho/embeddings/marco_docs/$model/full-queries-run-splits/less-opacus-triplet-gaussian-noise-1pc/hardnegs_less_opacus.full.qs.$1.txt \
    --output_dir temp \
    --model_name_or_path /data/user_data/jmcoelho/models/$prefix/$model \
    --dataset_cache_dir /data/datasets/hf_cache \
    --cache_dir /data/datasets/hf_cache \
