...
python -m tevatron.retriever.driver.select_hard_negatives \
    ...
    --train_run_path /data/user_data/jmcoelho/embeddings/marco_docs/pythia-160m-marco-docs-bow-pretrain/opacus_train_run_splits/run.train.opacus.$1 \
    --train_qrels /data/user_data/jmcoelho/datasets/marco/documents/qrels.train.tsv \
    --embedding_path /data/user_data/jmcoelho/embeddings/marco_docs/$model/valid_grads/ \
    --number_of_negatives $n_negatives \
    --negatives_out_file /data/user_data/jmcoelho/embeddings/marco_docs/pythia-160m-marco-docs-bow-pretrain/opacus_train_run_splits/opacus_less/hardnegs_less_opacus_$1.txt \
    --output_dir temp \
