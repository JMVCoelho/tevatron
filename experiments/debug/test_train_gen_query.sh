...
# accelerate launch --multi_gpu --num_processes 8 scripts/train_query_generator.py \
#     --output_model_path /data/user_data/jmcoelho/models/query_generators/$final_model_name \
# 	--wandb_run_name $final_model_name \
...
final_model_name=pilet5-large-gpt-query-gen-512

python scripts/train_query_generator.py \
    --output_model_path /data/user_data/jmcoelho/models/query_generators/$final_model_name \
	--wandb_run_name $final_model_name \
    --train_pairs_path /data/group_data/cx_group/query_generation_data/GPT4/train.jsonl \
    --eval_pairs_path /data/group_data/cx_group/query_generation_data/GPT4/val.jsonl \
    --base_model EleutherAI/pile-t5-large \
    --max_tokens 512 \
    --save_every_n_steps 0 \
    --learning_rate 3e-4 \
